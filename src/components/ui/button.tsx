...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-[#90323D] text-white hover:bg-[#6e2530] active:scale-[0.98]',
        coral:
          'bg-[#F8756C] text-white hover:bg-[#e05f57] active:scale-[0.98]',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-[#90323D] text-[#90323D] bg-transparent hover:bg-[#90323D] hover:text-white',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost:
          'text-[#303030] hover:bg-[#90323D]/10 hover:text-[#90323D]',
        link:
          'text-[#90323D] underline-offset-4 hover:underline',
      },
      size: {
